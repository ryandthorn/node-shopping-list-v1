...
Recipes.create('grilled cheese sandwich', ['bread','cheese','butter']);
Recipes.create('rice and beans', ['rice','beans','water','olive oil']);
Recipes.create('mirepoix', ['carrots','onions','celery']);
